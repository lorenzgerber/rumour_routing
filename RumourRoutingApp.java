...
public class RumourRoutingApp
{
    public static void main( String[] args )
    {
        ...
        if (NEW_EVENTS > 1 || NEW_EVENTS < 0)
            throw new IllegalArgumentException("NEW_EVENTS must be a number between 0 and 1");

        if (PROB_AGENT > 1 || PROB_AGENT < 0)
            throw new IllegalArgumentException("PROB_AGENT must be a number between 0 and 1");
